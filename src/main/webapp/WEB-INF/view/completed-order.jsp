...
<div align="center">
    <form:form action="saveCompletedOrder" class="ui-form" modelAttribute="order">
        <h2 align="center">${user.userDetails.name}, вы закрываете заявку, как выполненую!</h2>
        <table>
            <tr>
            ...
            <tr>
                <td align="left">Договор № ${order.nameContract}</td>
                <td align="right">Сумма по договору : ${order.summOfContract}</td>
            </tr>
            <tr>
