...
import com.silverwork.teplo_tex_stroi.exception_handling.NoSuchOrderDetailsException;
...
public class RESTControllerOrder {
    ...
    @PostMapping("/order")
    public Order saveOrder(@RequestBody OrderDetails orderDetailsExternal) {
